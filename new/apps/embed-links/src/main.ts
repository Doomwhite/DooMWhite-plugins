...
export class Settings implements Logging {
	...
	popup: boolean = true;
	rmDismiss: boolean = false;
	autoEmbedWhenEmpty: boolean = false;
	primary: string = 'microlink';
	backup: string = 'jsonlink';
	inPlace: boolean = false;
	debug: boolean = false;
	delay: number = 0;
}

export default class EmbedLinksPlugin extends Plugin {
